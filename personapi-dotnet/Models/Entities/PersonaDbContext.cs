...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost,1434;Database=persona_db;User Id=sa;Password=Laboratorio1*;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Estudio>(entity =>
        {
            entity.HasKey(e => new { e.IdProf, e.CcPer }).HasName("PK__estudios__FB3F71A6E6311592");
        ...
        {
            entity.HasKey(e => e.Cc).HasName("PK__persona__3213666DA6AEB3D0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__profesio__3213E83F35A19E6C");
        ...
        {
            entity.HasKey(e => e.Num).HasName("PK__telefono__DF908D6507D4F573");
